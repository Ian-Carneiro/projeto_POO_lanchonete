...
public class Pedido {
	...
	public void setNumeroPedido(int i) {//define o numero de um pedido especÃ­fico
		numeroPedido = i;
	}
	...
	public String toString() {
		...
		return quantidade+" - "+produto.getNome()+" - Subtotal: "+getValorTotal()+" -- nÂ°:"+getNumeroPedido()+" ==> "+s+"\n";
	}
}
